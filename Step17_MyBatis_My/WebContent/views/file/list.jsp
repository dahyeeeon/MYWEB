...
<div class="text-center">
	<nav class="Page navigation example">
	 <ul class="pagination">
		<c:choose>
			<c:when test="${startPageNum ne 1 }"> <!-- == eq, != ne -->
				<li class="page-item"><a href="list.do?pageNum=${startPageNum-1 }">Prev</a></li>
			</c:when>
			<c:otherwise>
				<li class="page-item"><a class="muted" href="javascript:">Prev</a></li>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			<c:when test="${endPageNum lt totalPageCount }">
				<li class="page-item"><a href="list.do?pageNum=${endPageNum+1 }">Next</a></li>
			</c:when>
			<c:otherwise>
				<li class="page-item"><a class="muted" href="javascript:">Next</a></li>
			</c:otherwise>
		</c:choose>
		</ul>
	</nav>
